    ...
    <div className="min-h-[calc(100vh-64px)] bg-gradient-to-b from-sky-50 to-white">
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-[#156669] mb-6 leading-tight">
            Clinical Report
            <span className="text-[#7faaca]"> Analysis Platform</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Link
              to="/signup"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#b8d2e4] text-[#156669] rounded-lg font-bold text-lg hover:bg-[#7faaca] transition-all shadow-md"
            >
              Create Account
              <FaArrowRight />
            </Link>
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-[#7faaca] rounded-lg font-bold text-lg border-2 border-gray-300 hover:border-[#7faaca] transition-all"
            >
              Patient Login
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="text-center bg-white rounded-lg p-4 border border-teal-100">
              <FaMicroscope className="text-3xl text-[#7faaca] mx-auto mb-2" />
              <p className="text-sm font-semibold text-[#7faaca]">AI Analysis</p>
            </div>
            <div className="text-center bg-white rounded-lg p-4 border border-teal-100">
              <FaChartLine className="text-3xl text-[#7faaca] mx-auto mb-2" />
              <p className="text-sm font-semibold text-[#7faaca]">Health Trends</p>
            </div>
            <div className="text-center bg-white rounded-lg p-4 border border-teal-100">
              <FaLock className="text-3xl text-[#7faaca] mx-auto mb-2" />
              <p className="text-sm font-semibold text-[#7faaca]">HIPAA Secure</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex justify-center">
          <div className="relative w-96 h-80 bg-white rounded-2xl shadow-2xl p-6">
            ...
            <div className="h-32 bg-gradient-to-r from-teal-100 to-blue-100 rounded-xl flex items-end p-4 gap-3">
              <div className="w-8 h-16 bg-[#7faaca] rounded-lg" />
              <div className="w-8 h-24 bg-[#7faaca] rounded-lg" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-center text-[#156669] mb-12">Clinical Workflow</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-8 border-2 border-teal-100 hover:border-teal-300 transition-all">
            <div className="w-16 h-16 bg-teal-100 rounded-lg flex items-center justify-center text-3xl mb-4">
              <FaClipboardList className="text-[#7faaca]" />
            </div>
            <h3 className="text-xl font-bold text-[#156669] mb-3">1. Upload Medical Reports</h3>
          ...
          <div className="bg-white rounded-xl p-8 border-2 border-teal-100 hover:border-teal-300 transition-all">
            <div className="w-16 h-16 bg-teal-100 rounded-lg flex items-center justify-center text-3xl mb-4">
              <FaMicroscope className="text-[#7faaca]" />
            </div>
            <h3 className="text-xl font-bold text-[#156669] mb-3">2. Clinical AI Analysis</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-xl p-8 border-2 border-teal-100 hover:border-teal-300 transition-all">
            <div className="w-16 h-16 bg-teal-100 rounded-lg flex items-center justify-center text-3xl mb-4">
              <FaChartLine className="text-[#7faaca]" />
            </div>
            <h3 className="text-xl font-bold text-[#156669] mb-3">3. Monitor Health Trends</h3>
            <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-xl border-2 border-teal-200 p-8 mb-6">
          <div className="flex items-center justify-center gap-12">
            <div className="text-center">
              <FaShieldAlt className="text-4xl text-[#7faaca] mx-auto mb-2" />
              <div className="text-2xl font-bold text-[#7faaca] mb-1">HIPAA</div>
              <div className="text-xs text-gray-600">Compliant</div>
            </div>
            <div className="w-px h-12 bg-gray-300"></div>
            <div className="text-center">
              <FaLock className="text-4xl text-[#7faaca] mx-auto mb-2" />
              <div className="text-2xl font-bold text-[#7faaca] mb-1">256-bit</div>
              <div className="text-xs text-gray-600">Encryption</div>
            </div>
            <div className="w-px h-12 bg-gray-300"></div>
            <div className="text-center">
              <FaClock className="text-4xl text-[#7faaca] mx-auto mb-2" />
              <div className="text-2xl font-bold text-[#7faaca] mb-1">24/7</div>
              <div className="text-xs text-gray-600">Secure Access</div>
            </div>
          </div>
        </div>
        <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6">
          <p className="text-sm text-[#7faaca] text-center flex items-center justify-center gap-2">
